...
var textMenuDrink = `
    ...
    *Пиво 
    ...
    Reeper B. 0,5L - 300р
    -Светлое пастеризованное фильтрованное (Германия)
    Warsteiner 0,5L - 300р 
    -Светлое пастеризованное фильтрованное (Германия)
    WelfBrau 0,5L - 300р
    -Светлое фильтрованное пастеризованное (Германия)
    Pabst Blue Ribbon 0,5L - 300р
    -Светлое непастеризованное фильтрованное (Соединенное Королевство)
    Grolsch 0,5L - 300р
